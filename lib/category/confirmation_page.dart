                 ...
                 Padding(
                  ...
                  const SizedBox(height: 16.0),
                   Card(
                              ...
                              color: const Color.fromARGB(255, 185, 92, 15), // Set background color here
                              child: Padding(
                                padding: const EdgeInsets.all(16.0),
                                child: Column(
                    ...
                    ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Card(
                                    ...
                                    color: const Color.fromARGB(255, 228, 153, 92), // Set background color here
                                    child: ListTile(
                    ...
                    ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.all(16), // Increase padding for a bigger button
                            shape: const CircleBorder(),
                            backgroundColor: const Color.fromARGB(255, 161, 94, 26), // Background color
                    ...
                    TextButton(
                          ...
                          child: const Text(
                            'Logout',
                            style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 56, 28, 1)),
                          ),
                    ),
                  ],
                ),
